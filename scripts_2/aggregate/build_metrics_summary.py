...
def main():
    ...
    print(f"[SAVE] {out_csv} rows={len(out_df)} targets={len(targets)}")
    if args.skipped_csv is not None:
...
특정 타겟만
TARGET="abl1"
python /home/deepfold/users/hosung/dataset/DUD-E/scripts_2/aggregate/build_metrics_summary.py \
  --dude_root /home/deepfold/users/hosung/dataset/DUD-E/dude_raw \
  --eval_subdir diffdock_2 \
  --targets $TARGET \
  --out_csv /home/deepfold/users/hosung/dataset/DUD-E/dude_raw/metrics_summary_all_diffdock_2.csv
  
자동 탐색(이미 master_table.csv 있는 타겟만 모아서 실행)
python /home/deepfold/users/hosung/dataset/DUD-E/scripts_2/aggregate/build_metrics_summary.py \
  --dude_root /home/deepfold/users/hosung/dataset/DUD-E/dude_raw \
  --eval_subdir diffdock_2 \
  --out_csv /home/deepfold/users/hosung/dataset/DUD-E/dude_raw/metrics_summary_all_diffdock_2.csv
...
디버그 로그 저장(스킵/에러 원인 추적용)
python /home/deepfold/users/hosung/dataset/DUD-E/scripts_2/aggregate/build_metrics_summary.py \
  --dude_root /home/deepfold/users/hosung/dataset/DUD-E/dude_raw \
  --eval_subdir diffdock_2 \
  --out_csv /home/deepfold/users/hosung/dataset/DUD-E/dude_raw/metrics_summary_all_diffdock_2.csv \
  --skipped_csv /home/deepfold/users/hosung/dataset/DUD-E/dude_raw/_debug_skipped.csv \
  --errors_csv  /home/deepfold/users/hosung/dataset/DUD-E/dude_raw/_debug_errors.csv
'''